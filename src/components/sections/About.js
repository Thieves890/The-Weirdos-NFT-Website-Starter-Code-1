    ...
    return (
        <Section id="about">
            <Container>
                ...
                <Box>
                <Title>
                    Welcome To <br /> Apes List.
                </Title>
                <SubText>
                Apes List is a private collection of unique digital collectibles. Apes are stored as ERC-721 tokens on the Ethereum blockchain and hosted on IPFS.
                </SubText>
                <SubTextLight>
                ...
                <Button text="JOIN OUR DISCORD" link="https://discord.gg/apeslist" />
                </ThemeProvider>
                </ButtonContainer>
                </Box>
            </Container>
